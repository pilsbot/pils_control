...
using CallbackReturn = acker_diff_controller::CallbackReturn;
...
class TestableDiffDriveController : public acker_diff_controller::AckerDiffController
{
public:
  using AckerDiffController::AckerDiffController;
