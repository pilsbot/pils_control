...
CallbackReturn AckerDiffController::configure_hoverboard_api_sensors(
...
CallbackReturn AckerDiffController::configure_head_mcu_sensors(
...
void AckerDiffController::publish_available_sensors()
{
